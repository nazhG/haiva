    ...
    return (
        <main className="flex flex-col">
            ...
            <section className="flex flex-col items-center font-poppins">
                ...
                <h4 className="text-primary mb-12 text-center sm:px-6">Overburdened Therapists, Underserved Patients</h4>
                <div className="flex max-w-[1440px] gap-12 mb-20">
                    <img className="w-2/5 md:hidden" src="https://s3-alpha-sig.figma.com/img/5474/a6b1/8be1fcc54af0c5f4934e6d940c1fece9?Expires=1728864000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=ERBGW6aVqQhEGujLjbYEM02KwdSSCU10rNAlyThZPFgRruTAUUZ2Nw7qLoGXAMGdEI-EZoZb2rXCuUZ38rmeSR0xyqkGazbFMXOF9bnflox3SpCjby592BEi9TYQQYzu71kGBCCLtJ-hShHtealCnNyPLevHEvoRFcjokELsVRVhsMPT7figvUzsNvdSMwqaw5MfeuBjcckf7h-ZGB14ObvfKJQ5l~6p0Jnt1i6Vd6PqIUrAIHvpjmSmxapGuA1DDt3zgV3vKMIR1bI-k3YSNEWUiESZ0lw2DJ2cSmV4mX9EDDZGj7nqwbO9sEnfC-u4QCY12QgOl3SgU3LL64dnRw__" alt="Files" />
                    <div className="w-3/5 md:w-full md:px-8 flex flex-col">
                        ...
                        <ul className="list-disc h-full flex flex-col justify-between">
                            <li className="mb-1">High demand with limited resources</li>
                            <li className="mb-1">Therapists spend up to 30% of their time on admin tasks</li>
                            <li className="mb-1">Manual documentation is time-consuming and prone to errors</li>
                            <li className="mb-1">Burnout rates among professionals are alarmingly high</li>
                            <li className="mb-1">Lack of real-time emotional and behavioral analysis in sessions.</li>
                            <li className="mb-1">Difficulty in integrating new technologies with existing systems.</li>
                        </ul>
                    </div>
                </div>
                <div className="flex flex-wrap gap-16 w-full justify-center mb-8">
                ...
                <div className="flex justify-center w-full mb-16">
                    <div className=" flex flex-wrap gap-x-12 gap-y-6 justify-center">
                        <div className="flex flex-col text-center w-[250px]">
                ...
                <div className="flex flex-col justify-center text-center w-full mb-8 px-20 sm:px-8">
                    ...
                    <div className="flex md:flex-col gap-6 mb-16 items-center">
                        <span className="w-1/4 sm:w-full font-semibold text-3xl">What is <span className="text-light">haiva</span>?</span>
                        <div className="border-black border-l-[1px] border-b-[1px] h-28 md:h-[1px] w-[1px] md:w-full"></div>
                    ...
                    <div className="flex flex-wrap gap-6 mb-12 justify-center">
                        <div className="flex flex-col rounded-2xl bg-lightest px-2 gap-3 py-8 w-52">
