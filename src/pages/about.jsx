    ...
    return (
        <main className="flex flex-col">
            ...
            <section className="flex flex-col items-center font-poppins">
                ...
                <h4 className="text-primary mb-12 text-center sm:px-2">Overburdened Therapists, Underserved Patients</h4>
                <div className="flex max-w-[1440px] gap-12 mb-20">
                    ...
                    <div className="w-3/5 md:w-full md:px-5 flex flex-col">
